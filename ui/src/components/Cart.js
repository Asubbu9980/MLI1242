...
<Card>
      ...
      return(
        <>
        <Card.Title>{item.symbol}{item.name}<span onClick={()=>{removeItem(cartitems,"name",item.name) ;console.log(cartitems)}} style={{marginLeft:"190px",fontSize:"15px",color:"red",cursor:"pointer"}}>Remove</span></Card.Title>
